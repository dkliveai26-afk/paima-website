...
export function PaimaDesignDiscovery() {
  ...
  return (
    <div className="min-h-screen bg-[#E1D4C2] text-black pt-28 pb-24 px-4 sm:px-6 lg:px-12 selection:bg-black selection:text-[#E1D4C2]">
      {/* BRAND HERO HEADER */}
      <div className="max-w-7xl mx-auto mb-10 pb-8 border-b border-[#A78D78]/50">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-black leading-[1.1]">
              Discover Spatial <br />
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-black bg-[#BEB5A9]/50 text-black hover:bg-[#BEB5A9] text-xs font-sans uppercase tracking-[0.18em] font-extrabold transition-all duration-300 shadow-sm"
            >
      ...
      <div className="max-w-7xl mx-auto space-y-6 mb-12">
        ...
        <section className="bg-[#BEB5A9]/40 p-6 sm:p-8 rounded-3xl border border-[#A78D78]/40 shadow-sm space-y-4">
            ...
            {ROOM_TYPES.map((room) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "px-4 py-2.5 rounded-full text-xs font-sans uppercase tracking-[0.15em] font-extrabold transition-all duration-300 border",
                    isActive
            ...
            {PALETTES.map((pal) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "p-3.5 rounded-2xl border transition-all duration-300 flex flex-col items-center justify-center gap-2 text-center",
                    isActive
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#A78D78]/40">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                "px-3.5 py-1.5 rounded-full text-xs font-sans uppercase tracking-wider font-extrabold transition-all border",
                sortBy === "featured"
            ...
            <button
              ...
              className={cn(
                "px-3.5 py-1.5 rounded-full text-xs font-sans uppercase tracking-wider font-extrabold transition-all border flex items-center gap-1.5",
                sortBy === "most-loved"
                  ? "bg-black text-[#E1D4C2] border-black"
                  : "bg-[#BEB5A9]/40 text-black border-[#A78D78] hover:bg-[#BEB5A9]"
              )}
        ...
        {loading ? (
          ...
          <div className="py-16 text-center bg-[#BEB5A9]/30 rounded-3xl border border-[#A78D78]/40 space-y-4">
            ...
            <button
              type="button"
              onClick={handleResetFilters}
              className="px-6 py-2.5 rounded-full bg-[#A78D78] text-black text-xs font-sans uppercase tracking-widest font-extrabold border border-black shadow-md hover:bg-[#BEB5A9]"
            >
              RESET FILTERS
            </button>
          </div>
              ...
              {designs.map((design, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative bg-[#BEB5A9]/40 rounded-3xl overflow-hidden border border-[#A78D78]/50 hover:border-black transition-all duration-500 hover:shadow-2xl cursor-pointer flex flex-col justify-between"
                  >
                    <div>
                      {/* IMAGE CONTAINER */}
                      <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#BEB5A9]">
                        ...
                        <button
                          ...
                          className={cn(
                            "absolute top-3 right-3 p-2.5 rounded-full backdrop-blur-md border transition-all duration-300 flex items-center gap-1.5 shadow-md z-10",
                            isLiked
                      ...
                      <div className="p-6 space-y-3">
                        <div className="flex flex-wrap items-center gap-2 text-[9px] font-sans uppercase tracking-wider font-extrabold">
                        ...
                        <h4 className="font-serif text-xl font-bold tracking-tight text-black group-hover:text-black/80 transition-colors">
                          {design.title}
                        </h4>
                    ...
                    {/* BOTTOM ACTION BAR */}
                    <div className="px-6 pb-6 pt-2 flex items-center justify-between border-t border-[#A78D78]/30">
        ...
        {selectedDesign && (
          ...
          >
            <motion.div
              ...
              className="bg-[#E1D4C2] text-black max-w-3xl w-full rounded-3xl border border-black shadow-2xl overflow-hidden relative my-8"
            >
              {/* CLOSE BUTTON */}
              <button
                type="button"
              ...
              <div className="p-8 space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#A78D78]/50 pb-4">
                  <div>
                    <div className="flex flex-wrap items-center gap-2 text-[9px] font-sans uppercase tracking-wider font-extrabold mb-2">
                  ...
                  <button
                    ...
                    className={cn(
                      "px-5 py-2.5 rounded-full border text-xs font-sans uppercase tracking-widest font-extrabold flex items-center gap-2 transition-all shadow-md",
                ...
                <p className="font-sans text-sm font-medium leading-relaxed text-black/90">
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedDesign.materials.map((mat, i) => (
                        <span
                          key={i}
                          className="px-3.5 py-1.5 rounded-xl bg-[#BEB5A9]/60 border border-[#A78D78] text-xs font-sans font-bold text-black"
                        >
                          {mat}
                        </span>
                      ))}
